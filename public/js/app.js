  ...
  Dropdown.prototype.initSublevels = function () {
    ...
    this.element.addEventListener('keyup', function (event) {
      if (event.keyCode && event.keyCode == 9 || event.key && event.key == 'Tab') {
        ...
        if (!prevFocusElementParent) return; // element in focus and element prev in focus are siblings
        ...
        if (prevFocusElementSibling && focusElementParent && focusElementParent == prevFocusElementSibling) return; // shift tab -> element in focus triggers the submenu of the element prev in focus

        if (focusElementSibling && prevFocusElementParent && focusElementSibling == prevFocusElementParent) return;
        var focusElementParentParent = focusElementParent.parentNode.closest('.dropdown__menu'); // shift tab -> element in focus is inside the dropdown triggered by a siblings of the element prev in focus
...
(function () {
  ...
  Modal.prototype.showModal = function () {
    ...
    this.firstFocusable.focus(); // wait for the end of transitions before moving focus
...
__webpack_require__(/*! /home/saeed/projects/botq/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/saeed/projects/botq/resources/sass/app.scss */"./resources/sass/app.scss");
